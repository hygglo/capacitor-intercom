<p>
  This is a fork to fix issues messageComposer on android and implement displayArticle. Will be deleted when original plugin fixes that (and Capacitor 3.0)
</p>
